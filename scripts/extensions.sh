...
initialize_extension_manager() {
	...
	export EXTENSION_MANAGER_TMP_DIR="${TOP_DIR}/.tmp/.extensions/debug"
	...
	fragment_manager_cleanup_file="${TOP_DIR}"/.tmp/extension_function_cleanup.sh
...
enable_extension() {
	...
	for extension_base_path in "${TOP_DIR}/userpatches/extensions" "${EXTER}/extensions"; do
